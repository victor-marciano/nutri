                  ...
                  <v-expand-transition v-for="(training, index) in newTraining.trainings" :key="index">
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12">
                          <v-select label="Dia da semana" :items="weekDays" v-model="training.weekDay"></v-select>
                        </v-col>
                        <v-col cols="12">
                          <div class="d-flex justify-space-between">
                  ...
                  <v-row>
                    <v-col cols="12">
                     <v-expansion-panels
                        multiple                        
                      >
                        <v-expansion-panel v-for="(training, index) in newTraining.trainings" :key="index">
                          <v-expansion-panel-header>{{ training.weekDay }}</v-expansion-panel-header>
